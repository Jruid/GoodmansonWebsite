          ...
          <div class="box">
            ...
            <?php $testimonials = new WP_Query(array('post_type' => 'testimonials', 'tax_query' => array(array('taxonomy' => 'testimonials_category', 'field' => 'slug' 'terms' => 'residential')), 'posts_per_page' => 1, 'orderby' => 'rand')); ?>
            ...
            <?php endwhile ?>
  					...
  					<?php $testimonials = new WP_Query(array('post_type' => 'testimonials', 'tax_query' => array(array('taxonomy' => 'testimonials_category', 'field' => 'slug', 'terms' => 'commercial')), 'posts_per_page' => 1, 'orderby' => 'rand')); ?>
          	<?php if($testimonials->have_posts()): ?>	
            <?php while($testimonials->have_posts()): $testimonials->the_post() ?>  
  					<p>"<?php echo get_the_content() ?>"<br>
  					<em><?php echo get_the_title() ?></em></p>

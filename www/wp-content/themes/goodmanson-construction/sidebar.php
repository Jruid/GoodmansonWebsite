          ...
          <div class="box">
            ...
            <?php $testimonials = new WP_Query(array('post_type' => 'testimonials', 'tax_query' => array('taxonomy' => 'testimonials_category', 'field' => 'slug' 'terms' => 'residential'), 'post_per_page' => 1, 'orderby' => 'rand')); ?>
